...
# ACDS 17.1 590 win32 2018.02.12.12:54:11
# ----------------------------------------
...
# ----------------------------------------
# If lol is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lol.vho"
}
