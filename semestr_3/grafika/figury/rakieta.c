...
//  glRotatef(rotRamienia2, 1, 0, 0);
        ...
        //narysowanie bloku g³ównego rakiety
  glColor3f(1.0,1.0,1.0);
  glPushMatrix();
  // - sciany boczne
  glTranslatef(0.0, 0.0, -5.0);
  gluDisk(podstawaSciany, 0.0, 0.5, 20, 5);
  gluCylinder(podstawaSciany, 0.5, 0.5, 10.0, 20, 5);
  glTranslatef(0.0, 0.0, 10.0);
  gluCylinder(podstawaSciany, 0.5, 0.0, 2.45, 20, 5);
  glPopMatrix();
 
        //narysowanie stabilizatorów pionowych (gora)
  glColor3f(1.0,1.0,1.0);
  glPushMatrix();
  // - sciany boczne
  glTranslatef(0.0, 0.5, -5.0+1.0);
  glRotatef(-rotRamienia2, 1, 0, 0);
  ...
  glPopMatrix();
        ...
        //narysowanie stabilizatorów pionowych (dol)
  glColor3f(1.0,1.0,1.0);
  glPushMatrix();
  // - sciany boczne
  glTranslatef(0.0, -0.5, -5.0+1.0);
  ...
  glPopMatrix();
        ...
        //narysowanie stabilizatorów poziomych (prawy)
  glColor3f(1.0,1.0,1.0);
  glPushMatrix();
  // - sciany boczne
  glTranslatef(0.5, 0.0, -5.0+1.0);
  ...
  glPopMatrix();
        ...
        //narysowanie stabilizatorów poziomych (lewy)
  glColor3f(1.0,1.0,1.0);
  glPushMatrix();
  // - sciany boczne
  glTranslatef(-0.5, 0.0, -5.0+1.0);
...
void ObslugaKlawiatury(unsigned char klawisz, int x, int y)
{
  ...
  switch(klawisz)
    ...
    case '#':
      rotRamienia2 = (rotRamienia2 < 30.0) ? rotRamienia2 + 1.0 : rotRamienia2;
      break;
    ...
    case '%':
      ...
      break;
        case '+':
          Obserwator = (Obserwator>15) ? Obserwator-1 : Obserwator;
          break;
        case '-':
          Obserwator = (Obserwator<60) ? Obserwator+1 : Obserwator;
          break;
    }
