//////////////////////////////////////////////////////////////////////////////////////////
// sferoida by Majkel (wspolrzedne sferyczne)
//
// sterowanie:
     ...
     glColor3f(1,1,1);
      for(fi = 0; fi <= PI; fi += skok_poz){
            ...
            for(theta = 0; theta <= 2*PI; theta += skok_pion){
                      glVertex3f(a*cos(theta)*cos(fi),b*sin(theta),a*cos(theta)*sin(fi));
                      glVertex3f(a*cos(theta)*cos(fi+skok_poz),b*sin(theta),a*cos(theta)*sin(fi+skok_poz));
            }
            glEnd();     
     }
}
...
void WyswietlObraz(void)
{
  ...
  RysujSferoide(promien1,promien2);
