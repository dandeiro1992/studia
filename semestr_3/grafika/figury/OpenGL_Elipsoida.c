//////////////////////////////////////////////////////////////////////////////////////////
// elipsoida by Majkel (wspolrzedne sferyczne)
//
// sterowanie:
...
// Prototypy funkcji
void RysujElipsoide(double r, double a, double b, double c);
     ...
     glColor3f(1,1,1);
      for(fi = 0; fi < PI; fi += skok_poz){
            ...
            for(theta = 0; theta <= 2*PI; theta += skok_pion){
                      glVertex3f(a*r*cos(theta)*sin(fi),c*r*cos(fi),b*r*sin(theta)*sin(fi));
                      glVertex3f(a*r*cos(theta)*sin(fi+skok_poz),c*r*cos(fi+skok_poz),b*r*sin(theta)*sin(fi+skok_poz));
            }
            glEnd();     
     }
}
